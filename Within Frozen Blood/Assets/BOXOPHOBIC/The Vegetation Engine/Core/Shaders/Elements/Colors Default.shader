	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 temp_output_11_0_g19248 = ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw );
				half4 tex2DNode17_g19248 = tex2D( _MainTex, temp_output_11_0_g19248 );
				half temp_output_7_0_g19359 = _MainTexMinValue;
				half4 temp_cast_0 = (temp_output_7_0_g19359).xxxx;
				half4 break469_g19248 = saturate( ( ( tex2DNode17_g19248 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g19359 ) ) );
				...
				half2 temp_output_851_0_g19248 = saturate( ( ( abs( (( (temp_output_35_0_g19367).zw + ( (temp_output_35_0_g19367).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g19363 ) ) );
...
/*ASEBEGIN
Version=18909
1920;2;1920;1027;1346.644;1004.456;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;178;-640,-640;Half;False;Property;_render_colormask;_render_colormask;51;1;[HideInInspector];Create;True;0;0;0;True;0;False;14;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;186;-640,-768;Inherit;False;Define ELEMENT COLORS;49;;19238;378049ebac362e14aae08c2daa8ed737;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;197;-640,-512;Inherit;False;Base Element;2;;19248;0e972c73cae2ee54ea51acc9738801d0;7,477,0,478,0,145,0,481,0,576,1,491,1,903,0;0;1;FLOAT4;0
...
ASEEND*/
//CHKSM=FADBCA7BB2496975DB67FFAD9459742118F5B2AF