	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 temp_output_11_0_g19316 = ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw );
				half4 tex2DNode17_g19316 = tex2D( _MainTex, temp_output_11_0_g19316 );
				...
				half2 temp_output_851_0_g19316 = saturate( ( ( abs( (( (temp_output_35_0_g19367).zw + ( (temp_output_35_0_g19367).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_0 ) / ( 1.0 - temp_output_7_0_g19363 ) ) );
...
/*ASEBEGIN
Version=18909
1920;2;1920;1027;1387.167;1064.816;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;139;-640,-640;Half;False;Property;_render_colormask;_render_colormask;51;1;[HideInInspector];Create;True;0;0;0;True;0;False;14;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;108;-640,-768;Inherit;False;Define ELEMENT COLORS;49;;19315;378049ebac362e14aae08c2daa8ed737;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;142;-640,-512;Inherit;False;Base Element;2;;19316;0e972c73cae2ee54ea51acc9738801d0;7,477,0,478,1,145,0,481,0,576,1,491,1,903,0;0;1;FLOAT4;0
...
ASEEND*/
//CHKSM=E690E7078104F9D0F27817D127F65D1E00B6D6EF