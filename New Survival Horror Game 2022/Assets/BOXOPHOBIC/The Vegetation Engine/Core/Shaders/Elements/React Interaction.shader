	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				float2 temp_output_11_0_g19296 = ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode17_g19296 = tex2D( _MainTex, temp_output_11_0_g19296 );
				float temp_output_7_0_g19359 = _MainTexMinValue;
				float4 temp_cast_0 = (temp_output_7_0_g19359).xxxx;
				float4 break469_g19296 = saturate( ( ( tex2DNode17_g19296 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g19359 ) ) );
				...
				float temp_output_7_0_g19368 = -ase_objectScale.x;
				half normalX_WS284_g19296 = ( ( temp_output_275_0_g19296.x - temp_output_7_0_g19368 ) / ( ase_objectScale.x - temp_output_7_0_g19368 ) );
				...
				float temp_output_7_0_g19365 = -ase_objectScale.z;
				half normalZ_WS285_g19296 = ( ( temp_output_275_0_g19296.z - temp_output_7_0_g19365 ) / ( ase_objectScale.z - temp_output_7_0_g19365 ) );
				...
				float4 temp_output_35_0_g19367 = localIS_ELEMENT37_g19361;
				float temp_output_7_0_g19363 = TVE_ElementsFadeValue;
				float2 temp_cast_5 = (temp_output_7_0_g19363).xx;
				float2 temp_output_851_0_g19296 = saturate( ( ( abs( (( (temp_output_35_0_g19367).zw + ( (temp_output_35_0_g19367).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_5 ) / ( 1.0 - temp_output_7_0_g19363 ) ) );
...
/*ASEBEGIN
Version=18909
1920;2;1920;1027;1605.803;1671.291;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;172;-640,-1024;Inherit;False;Base Element;4;;19296;0e972c73cae2ee54ea51acc9738801d0;7,477,2,478,0,145,3,481,0,576,1,491,1,903,0;0;1;FLOAT4;0
...
ASEEND*/
//CHKSM=2842BA52E6B8BD10A1C33F44620FC54A4A47FACF