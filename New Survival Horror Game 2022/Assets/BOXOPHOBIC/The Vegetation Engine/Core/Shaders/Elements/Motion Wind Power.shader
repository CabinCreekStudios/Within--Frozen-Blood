	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 temp_output_11_0_g19305 = ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw );
				half4 tex2DNode17_g19305 = tex2D( _MainTex, temp_output_11_0_g19305 );
				half temp_output_7_0_g19359 = _MainTexMinValue;
				half4 temp_cast_0 = (temp_output_7_0_g19359).xxxx;
				half4 break469_g19305 = saturate( ( ( tex2DNode17_g19305 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g19359 ) ) );
				...
				half2 temp_output_851_0_g19305 = saturate( ( ( abs( (( (temp_output_35_0_g19367).zw + ( (temp_output_35_0_g19367).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g19363 ) ) );
...
/*ASEBEGIN
Version=18909
1920;2;1920;1027;1102.101;2093.039;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;143;-256,-1280;Inherit;False;Base Element;4;;19305;0e972c73cae2ee54ea51acc9738801d0;7,477,2,478,0,145,3,481,3,576,1,491,1,903,0;0;1;FLOAT4;0
...
ASEEND*/
//CHKSM=362D5B72098A5B15621D8FB0717E24AD311A360D