...
Shader "BOXOPHOBIC/The Vegetation Engine/Elements/Default/Colors Noise"
{
	Properties
	{
		...
		[HideInInspector]_NoiseMinValue("Noise Min", Range( 0 , 1)) = 0.25
		[HideInInspector]_MainTexMinValue("Element Min", Range( 0 , 1)) = 0
		[HideInInspector]_NoiseMaxValue("Noise Max", Range( 0 , 1)) = 0.75
	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				float Noise_Scale892_g19142 = _NoiseScaleValue;
				half simpleNoise775_g19142 = SimpleNoise( (WorldPosition).xz*( Noise_Scale892_g19142 * 0.2 ) );
				half Noise_Min893_g19142 = _NoiseMinValue;
				half temp_output_7_0_g19373 = Noise_Min893_g19142;
				half Noise_Max894_g19142 = _NoiseMaxValue;
				half4 lerpResult772_g19142 = lerp( _NoiseColorOne , _NoiseColorTwo , saturate( ( ( simpleNoise775_g19142 - temp_output_7_0_g19373 ) / ( Noise_Max894_g19142 - temp_output_7_0_g19373 ) ) ));
				half3 Final_Noise_RGB784_g19142 = (lerpResult772_g19142).rgb;
				half4 Colors37_g19361 = TVE_ColorsCoord;
				half4 Extras37_g19361 = TVE_ExtrasCoord;
				half4 Motion37_g19361 = TVE_MotionCoord;
				half4 React37_g19361 = TVE_ReactCoord;
				half4 localIS_ELEMENT37_g19361 = IS_ELEMENT( Colors37_g19361 , Extras37_g19361 , Motion37_g19361 , React37_g19361 );
				half4 temp_output_35_0_g19367 = localIS_ELEMENT37_g19361;
				half temp_output_7_0_g19363 = TVE_ElementsFadeValue;
				half2 temp_cast_0 = (temp_output_7_0_g19363).xx;
				half2 temp_output_851_0_g19142 = saturate( ( ( abs( (( (temp_output_35_0_g19367).zw + ( (temp_output_35_0_g19367).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_0 ) / ( 1.0 - temp_output_7_0_g19363 ) ) );
				...
				half2 temp_output_11_0_g19142 = ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw );
				half4 tex2DNode17_g19142 = tex2D( _MainTex, temp_output_11_0_g19142 );
				half temp_output_7_0_g19359 = _MainTexMinValue;
				half4 temp_cast_1 = (temp_output_7_0_g19359).xxxx;
				half4 break469_g19142 = saturate( ( ( tex2DNode17_g19142 - temp_cast_1 ) / ( _MainTexMaxValue - temp_output_7_0_g19359 ) ) );
...
/*ASEBEGIN
Version=18909
1920;2;1920;1027;1397.909;1307.683;1;True;False
Node;AmplifyShaderEditor.FunctionNode;158;-640,-512;Inherit;False;Base Element;2;;19142;0e972c73cae2ee54ea51acc9738801d0;7,477,0,478,3,145,0,481,0,576,1,491,1,903,0;0;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;159;-640,-640;Half;False;Property;_render_colormask;_render_colormask;49;1;[HideInInspector];Create;True;0;0;0;True;0;False;14;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;108;-640,-768;Inherit;False;Define ELEMENT COLORS;50;;19374;378049ebac362e14aae08c2daa8ed737;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=87A1D8A07573B9E70E3E69724316DA70192139CD