        ...
        void UpgradeAsset()
        {
            if (userVersion < 500)
            {
                ...
                foreach (var asset in allMaterialGUIDs)
                {
                    ...
                    EditorUtility.DisplayProgressBar("The Vegetatin Engine", "Updating " + Path.GetFileName(path), (float)count * (1.0f / (float)length));
            ...
            Debug.Log("<b>[The Vegetation Engine Installer]</b> " + "The Vegetation Engine materials have been upgraded to version " + bannerVersion);
        }
