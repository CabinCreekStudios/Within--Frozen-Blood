	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half temp_output_9_0_g19371 = Base_Extras_RGB213_g18710;
				half sRGB8_g19371 = temp_output_9_0_g19371;
				half localGammaToLinearFloatFast8_g19371 = GammaToLinearFloatFast( sRGB8_g19371 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g19371 = temp_output_9_0_g19371;
				#else
				float staticSwitch1_g19371 = localGammaToLinearFloatFast8_g19371;
				#endif
				half3 appendResult209_g18710 = (half3(0.0 , staticSwitch1_g19371 , 0.0));
				half3 Final_Wetness_RGB249_g18710 = appendResult209_g18710;
				half2 temp_output_11_0_g18710 = ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw );
				half4 tex2DNode17_g18710 = tex2D( _MainTex, temp_output_11_0_g18710 );
				half temp_output_7_0_g19359 = _MainTexMinValue;
				half4 temp_cast_0 = (temp_output_7_0_g19359).xxxx;
				half4 break469_g18710 = saturate( ( ( tex2DNode17_g18710 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g19359 ) ) );
				...
				half2 temp_output_851_0_g18710 = saturate( ( ( abs( (( (temp_output_35_0_g19367).zw + ( (temp_output_35_0_g19367).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g19363 ) ) );
...
/*ASEBEGIN
Version=18909
1920;2;1920;1027;767.6006;1972.039;1;True;False
Node;AmplifyShaderEditor.FunctionNode;133;-256,-1280;Inherit;False;Base Element;2;;18710;0e972c73cae2ee54ea51acc9738801d0;7,477,1,478,0,145,1,481,0,576,1,491,1,903,0;0;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;124;-256,-1536;Inherit;False;Define ELEMENT EXTRAS;49;;19374;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=3D5618ECDAFFC17BD6D0DF5EC3540FAAD3F33FAA