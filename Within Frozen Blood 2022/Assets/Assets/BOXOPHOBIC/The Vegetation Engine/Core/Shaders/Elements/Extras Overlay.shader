	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half temp_output_9_0_g19372 = Base_Extras_RGB213_g18625;
				half sRGB8_g19372 = temp_output_9_0_g19372;
				half localGammaToLinearFloatFast8_g19372 = GammaToLinearFloatFast( sRGB8_g19372 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g19372 = temp_output_9_0_g19372;
				#else
				float staticSwitch1_g19372 = localGammaToLinearFloatFast8_g19372;
				#endif
				half3 appendResult239_g18625 = (half3(0.0 , 0.0 , staticSwitch1_g19372));
				half3 Final_Overlay_RGB238_g18625 = appendResult239_g18625;
				half2 temp_output_11_0_g18625 = ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw );
				half4 tex2DNode17_g18625 = tex2D( _MainTex, temp_output_11_0_g18625 );
				half temp_output_7_0_g19359 = _MainTexMinValue;
				half4 temp_cast_0 = (temp_output_7_0_g19359).xxxx;
				half4 break469_g18625 = saturate( ( ( tex2DNode17_g18625 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g19359 ) ) );
				...
				half2 temp_cast_1 = (temp_output_7_0_g19363).xx;
				half2 temp_output_851_0_g18625 = saturate( ( ( abs( (( (temp_output_35_0_g19367).zw + ( (temp_output_35_0_g19367).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g19363 ) ) );
...
/*ASEBEGIN
Version=18909
1920;2;1920;1027;1361.536;1858.973;1;True;False
Node;AmplifyShaderEditor.FunctionNode;116;-640,-1152;Inherit;False;Base Element;2;;18625;0e972c73cae2ee54ea51acc9738801d0;7,477,1,478,0,145,2,481,0,576,1,491,1,903,0;0;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;113;-640,-1408;Inherit;False;Define ELEMENT EXTRAS;49;;19374;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=5EED80024AB3B14DA8A4F426D6EF28A895D72851