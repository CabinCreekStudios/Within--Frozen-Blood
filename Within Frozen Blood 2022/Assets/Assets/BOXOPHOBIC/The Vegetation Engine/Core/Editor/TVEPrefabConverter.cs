...
namespace TheVegetationEngine
{
    public class TVEPrefabConverter : EditorWindow
    {
        ...
        OutputReadWrite outpurReadWrite = OutputReadWrite.MarkMeshesAsNonReadable;
        ...
        void DrawConversionSettings()
        {
            ...
            if (presetIndex != 0)
            {
                ...
                if (showAdvancedSettings)
                {
                    ...
                    outpurReadWrite = (OutputReadWrite)EditorGUILayout.EnumPopup(outpurReadWrite, stylePopup);
                    GUILayout.EndHorizontal();
        ...
        GameObject GetPrefabObjectRoot(GameObject selection)
        {
            ...
            if (selection != null)
            {
                if (PrefabUtility.GetPrefabAssetPathOfNearestInstanceRoot(selection).Length > 0)
                {
                    ...
                    {
                        Debug.Log("<b>[The Vegetation Engine]</b> " + "Prefabs with sub-asset such as Tree Creator of SpeedTree cannot be converted directly. Please create a new prefab from it first!");
                        prefabRoot = null;
                    }
                }
                else
        ...
        void SaveMesh(Mesh mesh)
        {
            ...
            if (outpurReadWrite == OutputReadWrite.MarkMeshesAsNonReadable)
            {
        ...
        void SetMaterialPostSettings(Material material)
        {
            ...
            if (sourceMotion2 == sourceMotion3 && optionMotion2 == optionMotion3 && actionMotion2 == actionMotion3)
            {
                ...
                {
                    material.SetInt("_VertexRollingMode", 0);
                }
            }
        }
        ...
        void GetOutputsFromPreset()
        {
            ...
            for (int i = 0; i < presetLines.Count; i++)
            {
                ...
                if (presetLines[i].StartsWith("OutputReadWrite"))
                {
                    ...
                    {
                        outpurReadWrite = OutputReadWrite.MarkMeshesAsReadable;
                    }
                    else
                    {
                        outpurReadWrite = OutputReadWrite.MarkMeshesAsNonReadable;
                    }
                }
