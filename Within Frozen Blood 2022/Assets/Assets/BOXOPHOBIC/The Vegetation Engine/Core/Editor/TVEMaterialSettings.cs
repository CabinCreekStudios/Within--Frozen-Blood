...
namespace TheVegetationEngine
{
    public class TVEMaterialSettings : EditorWindow
    {
        ...
        {
            new TVEMaterialData("_RenderMode", "Render Mode", -9999, new string[] {"Opaque", "Transparent"}, true),
            new TVEMaterialData("_RenderCull", "Render Faces", -9999, new string[] {"Both", "Back", "Front"}, false),
            new TVEMaterialData("_RenderNormals", "Render Normals", -9999, new string[] {"Flip", "Mirror", "Same"}, false),

            new TVEMaterialData("_RenderClip", "Alpha Clipping", -9999, new string[] {"Off", "On"}, true),
        ...
        {
            new TVEMaterialData("_LayerColorsValue", "Layer Colors", -9999, new string[] {"Default", "Layer 1", "Layer 2", "Layer 3", "Layer 4", "Layer 5", "Layer 6", "Layer 7", "Layer 8"}, true),
            new TVEMaterialData("_LayerExtrasValue", "Layer Extras", -9999, new string[] {"Default", "Layer 1", "Layer 2", "Layer 3", "Layer 4", "Layer 5", "Layer 6", "Layer 7", "Layer 8"}, false),
            new TVEMaterialData("_LayerMotionValue", "Layer Motion", -9999, new string[] {"Default", "Layer 1", "Layer 2", "Layer 3", "Layer 4", "Layer 5", "Layer 6", "Layer 7", "Layer 8"}, false),
            new TVEMaterialData("_LayerReactValue", "Layer React", -9999, new string[] {"Default", "Layer 1", "Layer 2", "Layer 3", "Layer 4", "Layer 5", "Layer 6", "Layer 7", "Layer 8"}, false),
        ...
        List<TVEMaterialData> motionData = new List<TVEMaterialData>
        {
            ...
            //new TVEMaterialData("_MotionMode_20", "Second Mode", "_MotionSpeed_20", -9999, new string[] {"Rolling", "Vertical", "Random", "Squash"}, true),
            ...
            new TVEMaterialData("_InteractionAmplitude", "Interaction Amplitude", -9999, 0, 1, false, true),
        ...
        void OnGUI()
        {
            ...
            for (int i = 0; i < materialData.Count; i++)
            {
                ...
                {
                    materialData[i].value = StyledOptions(materialData[i].name, materialData[i].value, materialData[i].options, materialData[i].space);
                }
        ...
        void DrawWindPower()
        {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Space(2);
            GUILayout.Label("Low", styleMid, GUILayout.Width(maxWidth));
            GUILayout.Label("", styleMid);
            GUILayout.Label("Medium", styleMid, GUILayout.Width(maxWidth));
            GUILayout.Label("", styleMid);
            GUILayout.Label("High", styleMid, GUILayout.Width(maxWidth));
            GUILayout.Space(7);
            GUILayout.EndHorizontal();
        }
        ...
        float StyledOptions(string name, float value, string[] options, bool space)
        {
            if (value == -9999)
            {
                return value;
            ...
            else
            {
                ...
                if (value == -8888)
                {
                    ...
                    EditorGUI.showMixedValue = true;
                    value = EditorGUILayout.Popup((int)value, options);
                    EditorGUI.showMixedValue = false;
                }
                else
                {
            ...
            for (int i = 0; i < selectedMaterials.Count; i++)
            {
                ...
                if (material != null)
                {
                    ...
                    for (int d = 0; d < materialData.Count; d++)
                    {
                        if (materialData[d].type == TVEMaterialData.PropertyType.Range)
                        {
                            if (material.HasProperty(materialData[d].prop) && material.HasProperty(materialData[d].dependency) && materialData[d].value > -99)
                            {
                        ...
                        {
                            if (material.HasProperty(materialData[d].prop) && material.HasProperty(materialData[d].dependency) && materialData[d].color.r > -99)
                            {
        ...
        void SetGlobalShaderProperties()
        {
            ...
            Shader.SetGlobalVector("TVE_MotionParams", new Vector4(windParams.x, windParams.y, windPower, windParams.w));
