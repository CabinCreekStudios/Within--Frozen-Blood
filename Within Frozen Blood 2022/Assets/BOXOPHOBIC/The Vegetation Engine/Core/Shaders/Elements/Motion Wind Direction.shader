	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 temp_cast_0 = (temp_output_7_0_g19363).xx;
				float2 temp_output_851_0_g19293 = saturate( ( ( abs( (( (temp_output_35_0_g19367).zw + ( (temp_output_35_0_g19367).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_0 ) / ( 1.0 - temp_output_7_0_g19363 ) ) );
...
/*ASEBEGIN
Version=18909
1920;2;1920;1027;1659.441;1771.434;1;True;False
Node;AmplifyShaderEditor.FunctionNode;117;-640,-1280;Inherit;False;Define ELEMENT MOTION;49;;19292;6eebc31017d99e84e811285e6a5d199d;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;154;-640,-1024;Inherit;False;Base Element;2;;19293;0e972c73cae2ee54ea51acc9738801d0;7,477,2,478,0,145,3,481,2,576,0,491,0,903,0;0;1;FLOAT4;0
...
ASEEND*/
//CHKSM=AA0469549313E5DB3BCCF551DC3383589653BCCF